...
usb_status_t usb_control_endpoint_process_get_descriptor(usb_setup_t *setup,
    ...
    usb_descriptor_type_t descriptor_type = (usb_descriptor_type_t)(setup->wValue >> 8);
...
usb_status_t usb_control_endpoint_process_endpoint_request(usb_setup_t *setup,
    ...
    usb_endpoint_direction_t ep_direction = (usb_endpoint_direction_t)(setup->wIndex & usb_endpoint_direction_in);
